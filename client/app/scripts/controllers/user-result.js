    ...
    .controller('UserResultController', [
        ...
        function ($scope, $routeParams, $location, apiService, loaderService, userService, dialogsService) {
            ...
            function sendUserSolution() {
                apiService.addUserSolution(entityTypeId, entityModelId, problemId, $scope.userSolution, {
                    success: function () {
            ...
            $scope.clearSolution = clearSolution;
            ...
            userService.getData({
                success: function (user) {
                    ...
                    apiService.getUserSolution(entityTypeId, entityModelId, problemId, {
